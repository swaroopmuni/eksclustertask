...
then
    ...
    curl https://github.com/swaroopmuni/eksclustertask/tree/main/.github/workflows/AmazonEKSClusterAutoscalerPolicy.json > AmazonEKSClusterAutoscalerPolicy.json
    ...
    curl https://github.com/swaroopmuni/eksclustertask/tree/main/.github/workflows/cluster-creation.yaml > cluster-creation.yaml
